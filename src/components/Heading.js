...
const Heading = ({widget, changeHeadingSize, changeHeadingText, changeWidgetName}) => {
    let selectElement;
    let inputElem;
    return (
        <div className="col-md-12">
            ...
            <div className="row">
                <div className="form-group col-md-12">
                    <select onChange={() => changeHeadingSize(widget.id, selectElement.value)} className="form-control"
