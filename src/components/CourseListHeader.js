    ...
    render() {
        return (
            <div className="row flex-row justify-content-between bg-light">
                ...
                <div className="col-md-4 py-2 text-black-50 text-left pl-5"><span><strong>Title</strong></span></div>
                <div className="col-md-2 py-2 text-black-50"><span className="float-right"><strong>Owned By</strong></span></div>
                <div className="col-md-2 py-2 text-black-50 text-center"><span><strong>Last Modified</strong></span></div>
